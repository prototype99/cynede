...
src_prepare() {
	...
	if use crossover; then
		PATCHES+=( "${FILESDIR}/wine-crossover-hack.patch" )
		PATCHES+=( "${FILESDIR}/wine-ntdll.patch" )
	fi
	if use d3d9; then
		if use staging; then
